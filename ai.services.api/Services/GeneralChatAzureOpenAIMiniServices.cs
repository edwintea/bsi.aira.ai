...
{
    public class GeneralChatAzureOpenAIMiniServices
    {
        ...
        private string azureOpenAIDeploymentName = Environment.GetEnvironmentVariable("azureOpenAIMiniDeploymentName");
        ...
        public GeneralChatAzureOpenAIMiniServices(HttpClient http)
        {
            _http = http;
